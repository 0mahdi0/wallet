<br><a style="float:right;" class="button" onclick="direction2()" >بازگشت</a><br>
<tr>
            ...
            <tr class="alternate" valign="top">
                ...
                <td class="column-columnname">
                    <div class="row-actions">
                        ...
                        <span class="edit"  name="select_trash" ><a onclick="<?php echo "popupConf".$wallet->id."()"; ?>">تایید</a></span>
                    </div>
                    <?php 
                               include  WPS_UWA."/wallet_add.php";
                        ?>
                </td>
            </tr>
<?php  }}}
